...
| `practise-app/` | The app you build (Phase 0 creates it) |
...
```bash
cd C:\Hello\My_Projects\JS-Practise\04-NextJs && npx create-next-app@latest practise-app --typescript --app --eslint --no-src-dir --no-tailwind
```
